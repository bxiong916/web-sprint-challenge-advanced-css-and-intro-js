...
console.log(artists[0].name); // The name of the first artist in the index of the array //

console.log(artists[2].bio); // the bio of the second artist in the index of the array //
